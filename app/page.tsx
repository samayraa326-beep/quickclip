...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="hero"><div className="hero-copy"><div className="pill">✦ On-demand video editing</div><h1>Great videos,<br/><em>without the wait.</em></h1><p>Tell us what you're creating, share your footage and get professional editing when you need it.</p><button className="primary" onClick={()=>setOpen(true)}>Start a video request <span>→</span></button><div className="trust"><span>✓ Transparent pricing</span><span>✓ Fast turnaround</span><span>✓ Simple workflow</span></div></div><div className="hero-card"><div className="mini-top"><span>QUICKCLIP</span><span className="live">● LIVE</span></div><div className="preview"><div className="play">▶</div><div className="timeline"><i/><i/><i/><i/><i/></div></div><div className="preview-info"><div><b>Your next video</b><small>Professional editing</small></div><strong>From ₹299</strong></div></div></section>
