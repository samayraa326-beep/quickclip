...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="edit-transform"><div className="transform-copy"><span className="eyebrow">THE EDIT MAKES THE DIFFERENCE</span><h2>From raw footage<br/><em>to scroll-stopping.</em></h2><p>Professionals turn ordinary footage into content people want to watch.</p></div><div className="transform-window"><div className="video-toolbar"><span>QUICKCLIP · EDIT PREVIEW</span><b>● LIVE EDIT</b></div><div className="before-after"><div className="raw-panel"><span className="video-tag">RAW FOOTAGE</span><div className="fake-video raw-video"><div className="subject">▶</div><div className="raw-lines"><i/><i/><i/></div></div><small>Uncut · No captions · Flat audio</small></div><div className="transform-arrow">→</div><div className="final-panel"><span className="video-tag">EDITED</span><div className="fake-video final-video"><div className="caption-pop">THIS VIEW ✨</div><div className="play-dot">▶</div><div className="progress"><i/></div></div><small>Captions · Color · Sound · Pacing</small></div></div><div className="edit-types"><span>Travel</span><span>Funny</span><span>Emotional</span><span>Podcast</span><span>Gaming</span></div></div></section>
